...
const ES: Dict = {
  ...
  "nav.blog": "Blog",
  "nav.company": "La agencia",
  "nav.about": "Quiénes somos",
  "nav.reviews": "Opiniones",
  "nav.contact": "Contacto",
  "nav.byRegion": "Por región",
  "nav.allCollections": "Todas las colecciones",
  "nav.allDestinations": "Todos los destinos",
  "nav.startTrip": "Empieza tu viaje",
  "nav.home": "Inicio",
  "nav.openMenu": "Abrir menú",
  "nav.closeMenu": "Cerrar menú",
  "nav.accountAria": "Cuenta: {email}",
  "nav.yourAccount": "Tu cuenta",
  "nav.signOut": "Cerrar sesión",
  "nav.signedIn": "Sesión iniciada",
  "nav.logInOrSignUp": "Inicia sesión o regístrate",
  "nav.logInSignUp": "Iniciar sesión / Registrarse",
  "nav.yourSkynovaAccount": "Tu cuenta Skynova",
  "nav.logInPrompt": "Inicia sesión para planear tu próximo viaje.",
  "nav.saveDestinations": "Guarda destinos y comparte viajes con amigos.",
  "nav.wishlist": "Lista de deseos",
  "nav.share": "Comparte Skynova con tus amigos",
  "nav.gift": "Regalo",
  "service.flights": "Vuelos",
  "service.hotels": "Hoteles",
  "service.carRentals": "Alquiler de coches",
  "service.airportServices": "Servicios de aeropuerto",
  "service.events": "Eventos y entradas",
  "service.esim": "SIM y eSIM",
  "service.tours": "Tours y actividades",
  "service.bikeRentals": "Alquiler de bicicletas",
  "footer.tagline":
    "Una sola búsqueda que llega a aerolíneas, hoteles y socios reales -- sin recargo, sin intermediarios, sin hacer malabares con seis pestañas.",
  "footer.book": "Reservar",
  "footer.company": "La agencia",
  "footer.contactUs": "Contáctanos",
  "footer.destinations": "Destinos",
  "footer.allDestinations": "Los {count} destinos",
  "footer.affiliate":
    "Skynova Agency funciona con la red de afiliación Travelpayouts -- los enlaces de reserva pueden generar una comisión sin coste adicional para ti.",
  "footer.privacy": "Política de privacidad",
  "footer.terms": "Condiciones de uso",
  "footer.followAlong": "Síguenos",
  "lang.label": "Idioma",
  "consent.aria": "Elección de cookies",
  "consent.copy":
    "Nos gustaría usar Google Analytics para saber qué páginas resultan realmente útiles — solo si lo aceptas. El contador de tráfico de Cloudflare funciona igualmente y no instala ninguna cookie.",
  "consent.readDetails": "Leer los detalles",
  ...
  "auth.saveTrips": "Guarda viajes y destinos.",
  ...
  "auth.resetSent":
    "Si esa dirección tiene una cuenta de Skynova, el enlace para elegir una contraseña nueva ya va en camino. Funciona una sola vez y caduca en una hora.",
  "auth.sendRequest": "Enviar solicitud",
  "auth.backToSignIn": "Volver a iniciar sesión",
  "auth.fineprintBefore": "Al crear una cuenta aceptas nuestras ",
  "auth.fineprintAnd": " y nuestra ",
  "auth.withAccount": "Con una cuenta",
  "auth.goodToKnow": "Bueno saberlo",
  "auth.saveDestinations": "Guardar destinos",
  "auth.giftTrip": "Regalar un viaje",
  "auth.earnReferrals": "Gana con las recomendaciones",
  "auth.freeToJoin": "Registro gratuito",
  "auth.noCard": "Sin tarjeta",
  "auth.neverResell": "Nunca revendemos tu correo",
  "search.eyebrow": "Planifícalo aquí",
  "search.heading": "¿A dónde vas?",
  "search.tablistAria": "Qué buscar",
  "search.destination": "Destino",
  "search.placeholder": "Portugal, Japón, Kenia…",
  "search.checkIn": "Entrada",
  "search.checkOut": "Salida",
  "search.go": "Buscar {what}",
  "search.modeHotels": "Hoteles",
  "search.modeFlights": "Vuelos",
  "search.modeCars": "Alquiler de coches",
  "search.modeTours": "Tours",
  "search.modeEsim": "eSIM",
  ...
  "news.copy":
    "Inspiración de destinos, ofertas de hoteles, guías de viaje, vuelos y experiencias seleccionadas -- directamente en tu bandeja de entrada.",
  "news.thanks": "Ya estás en la lista -- atento a nuestro próximo envío.",
  "news.placeholder": "Tu dirección de correo",
  "news.emailAria": "Dirección de correo",
...
const PT: Dict = {
  ...
  "nav.blog": "Blog",
  "nav.company": "A agência",
  "nav.about": "Sobre nós",
  "nav.reviews": "Avaliações",
  "nav.contact": "Contato",
  "nav.byRegion": "Por região",
  "nav.allCollections": "Todas as coleções",
  "nav.allDestinations": "Todos os destinos",
  "nav.startTrip": "Comece sua viagem",
  "nav.home": "Início",
  "nav.openMenu": "Abrir menu",
  "nav.closeMenu": "Fechar menu",
  "nav.accountAria": "Conta: {email}",
  "nav.yourAccount": "Sua conta",
  "nav.signOut": "Sair",
  "nav.signedIn": "Conectado",
  "nav.logInOrSignUp": "Entre ou cadastre-se",
  "nav.logInSignUp": "Entrar / Cadastrar",
  "nav.yourSkynovaAccount": "Sua conta Skynova",
  "nav.logInPrompt": "Entre para planejar sua próxima viagem.",
  "nav.saveDestinations": "Salve destinos e compartilhe viagens com amigos.",
  "nav.wishlist": "Lista de desejos",
  "nav.share": "Compartilhe a Skynova com amigos",
  "nav.gift": "Presente",
  "service.flights": "Voos",
  "service.hotels": "Hotéis",
  "service.carRentals": "Aluguel de carros",
  "service.airportServices": "Serviços de aeroporto",
  "service.events": "Eventos e ingressos",
  "service.esim": "SIM e eSIM",
  "service.tours": "Passeios e atividades",
  "service.bikeRentals": "Aluguel de bicicletas",
  "footer.tagline":
    "Uma única busca que alcança companhias aéreas, hotéis e parceiros reais -- sem acréscimo, sem intermediários, sem malabarismo com seis abas.",
  "footer.book": "Reservar",
  "footer.company": "A agência",
  "footer.contactUs": "Fale conosco",
  "footer.destinations": "Destinos",
  "footer.allDestinations": "Os {count} destinos",
  "footer.affiliate":
    "A Skynova Agency opera na rede de afiliados Travelpayouts -- os links de reserva podem gerar comissão sem custo adicional para você.",
  "footer.privacy": "Política de privacidade",
  "footer.terms": "Termos de uso",
  "footer.followAlong": "Acompanhe",
  "lang.label": "Idioma",
  "consent.aria": "Escolha de cookies",
  "consent.copy":
    "Gostaríamos de usar o Google Analytics para saber quais páginas são realmente úteis — somente se você concordar. O contador de tráfego da Cloudflare funciona de qualquer forma e não usa cookies.",
  "consent.readDetails": "Ler os detalhes",
  ...
  "auth.saveTrips": "Salve viagens e destinos.",
  "auth.email": "E-mail",
  "auth.password": "Senha",
  "auth.forgotPassword": "Esqueceu a senha?",
  "auth.createAccount": "Criar conta",
  "auth.pleaseWait": "Um momento...",
  "auth.genericError": "Algo deu errado. Tente novamente.",
  "auth.resetTitle": "Redefina sua senha.",
  "auth.resetIntro": "Informe o e-mail da sua conta e enviaremos um link para escolher uma nova senha.",
  "auth.resetSent":
    "Se esse e-mail tiver uma conta Skynova, o link para escolher uma nova senha já está a caminho. Ele funciona uma vez e expira em uma hora.",
  "auth.sendRequest": "Enviar solicitação",
  "auth.backToSignIn": "Voltar para entrar",
  "auth.fineprintBefore": "Ao criar uma conta, você aceita nossos ",
  "auth.fineprintAnd": " e nossa ",
  "auth.withAccount": "Com uma conta",
  "auth.goodToKnow": "Bom saber",
  "auth.saveDestinations": "Salvar destinos",
  "auth.giftTrip": "Presentear uma viagem",
  "auth.earnReferrals": "Ganhe com indicações",
  "auth.freeToJoin": "Cadastro gratuito",
  "auth.noCard": "Sem cartão",
  "auth.neverResell": "Nunca revendemos seu e-mail",
  "search.eyebrow": "Planeje aqui",
  "search.heading": "Para onde você vai?",
  "search.tablistAria": "O que buscar",
  "search.destination": "Destino",
  "search.placeholder": "Portugal, Japão, Quênia…",
  "search.checkIn": "Check-in",
  "search.checkOut": "Check-out",
  "search.go": "Buscar {what}",
  "search.modeHotels": "Hotéis",
  "search.modeFlights": "Voos",
  "search.modeCars": "Aluguel de carros",
  "search.modeTours": "Passeios",
  "search.modeEsim": "eSIM",
  ...
  "news.copy":
    "Inspiração de destinos, ofertas de hotéis, guias de viagem, promoções de voos e experiências selecionadas -- direto na sua caixa de entrada.",
  "news.thanks": "Você está na lista -- fique de olho no próximo envio.",
  "news.placeholder": "Seu e-mail",
  "news.emailAria": "Endereço de e-mail",
  "news.joining": "Entrando...",
