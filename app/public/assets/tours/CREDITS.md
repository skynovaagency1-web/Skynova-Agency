# Tour category photo credits

Sourced from Pexels, which licenses for commercial use. Attribution is not
required by the licence; recorded here so each image's origin is traceable.

These six are generic to the category rather than to a destination -- the
tours page sells ways to experience a place, not six particular places. All
are 1200x900 webp, matching the car and bike category photos.

| Category | Photographer | Source |
|---|---|---|
